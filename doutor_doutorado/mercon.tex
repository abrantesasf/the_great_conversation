...
\abstract{O texto abaixo é uma cópia do discurso do Prof.\ Dr.\ \textbf{Paulo Roberto Merçon
  ...
  Este documento está disponível para download em formato PDF em meu  
  \href{https://github.com/abrantesasf/the\_great\_conversation/tree/master/doutor\_doutorado}{repositório no GitHub}
  (\href{https://github.com/abrantesasf/the\_great\_conversation/raw/master/doutor\_doutorado/mercon.pdf}{link para download direto}).}
%\tableofcontents
%\newpage
